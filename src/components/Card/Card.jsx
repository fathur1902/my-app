...
export default function Card({product}) {
  return (
    <div>
         <div className="flex flex-col max-w-[300px] flex-wrap p-[14px] bg-[#081116]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="block font-medium text-[19px] text-white">{formatToIDRCurrency(product.price) ?? 'Not for sale'}</span>
          </div>
            {product.stock <= 0 ? (
